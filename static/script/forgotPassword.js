  ...
  $(".partitioned").keydown("input", function (event) {
    ...
    if (event.key == "Backspace") {
      ...
      document.getElementById("otp1").addEventListener("input", function () {
        var number = document.getElementById("otp1");
            ...
            if (data.error) {
              ...
              setTimeout(function () {
                $.ajax({
                  type: "post",
                  data: { email: email },
                  url: "/showModal/displayResetPassword",
                  success: function (data) {
                    $(".modal-content").html(data);
                    wrap("../static/script/resetPassword.js");
                  },
                });
              }, 3000);
            }
