...
function OnEdit(element, editPostId) {
    ...
    if (element.innerHTML == 'Edit') {
        ...
        $(".editPostInput" + editPostId).addClass("EditMode").removeClass("NormalMode");
        ...
        $.ajax({
            url: "/editPost/Edit",
            type: "POST",
            data: { 'editPostId': editPostId, 'editedTitle': editedTitle, 'editedDesc': editedDesc, 'editedContact': editedContact, 'editedCity': editedCity },
            success: function(res) {
                ...
                $(".editPostInput" + editPostId).addClass("NormalMode").removeClass("EditMode");
